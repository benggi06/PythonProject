    ...
    if fn == '2':
        ...
        for i in range(start_deg,end_deg+1):#시작 각도 ~ 마지막 각도
            ...
            if sin_value == 0:#사인값이 0일때
                ...
                print('{0}{1}│{2}*{3}{4}'.format(new_i,' '*(half+1),' '*loc1,' '*(loc2+1),sin_value))
        ...
        for i in range(start_deg,end_deg+1):#시작 각도 ~ 마지막 각도
            ...
            if cos_value == 0:#코사인값이 0일때
                ...
                print('{0}{1}│{2}*{3}{4}'.format(new_i,' '*(half+1),' '*loc1,' '*(loc2+1),cos_value))
            
            elif cos_value<0:#코사인값이 0 이하일때
                loc2=half+loc1
                cos_value='{:.3f}'.format(cos_value)
                print('{0}{1}*{2}│{3}{4}'.format(new_i,' '*loc2,' '*(half-loc2),' '*(half+1),cos_value))
